...
p;15;TNGrowlCenter.jt;10612;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/CPView.jI;24;AppKit/CPViewAnimation.ji;13;TNGrowlView.jt;10497;objj_executeFile("Foundation/Foundation.j", NO);
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_notificationsHistory"), new objj_ivar("_maxHistory"), new objj_ivar("_view"), new objj_ivar("_defaultLifeTime"), new objj_ivar("_useWindowMouseMoveEvents"), new objj_ivar("_notifications"), new objj_ivar("_notificationFrame")]);
...
{ with(self)
{
return _notificationsHistory;
}
},["id"]),
new objj_method(sel_getUid("setNotificationsHistory:"), function $TNGrowlCenter__setNotificationsHistory_(self, _cmd, newValue)
{ with(self)
{
_notificationsHistory = newValue;
}
},["void","id"]),
new objj_method(sel_getUid("maxHistory"), function $TNGrowlCenter__maxHistory(self, _cmd)
{ with(self)
{
return _maxHistory;
}
},["id"]),
new objj_method(sel_getUid("setMaxHistory:"), function $TNGrowlCenter__setMaxHistory_(self, _cmd, newValue)
{ with(self)
{
_maxHistory = newValue;
}
},["void","id"]),
...
new objj_method(sel_getUid("lifeDefaultTime"), function $TNGrowlCenter__lifeDefaultTime(self, _cmd)
{ with(self)
{
return _defaultLifeTime;
}
},["id"]),
new objj_method(sel_getUid("setLifeDefaultTime:"), function $TNGrowlCenter__setLifeDefaultTime_(self, _cmd, newValue)
{ with(self)
{
...
{ with(self)
{
    if (self = objj_msgSendSuper({ receiver:self, super_class:objj_getClass("TNGrowlCenter").super_class }, "init"))
    {
        ...
        _notificationsHistory = objj_msgSend(CPArray, "array");
        _maxHistory = 50;
...
{ with(self)
{
    ...
    objj_msgSend(_notificationsHistory, "addObject:", objj_msgSend(CPDictionary, "dictionaryWithObjectsAndKeys:", aTitle , "title",
                                                                                aMessage, "message",
                                                                                imageIcon, "icon",
                                                                                objj_msgSend(CPDate, "date"), "date"));
    if (objj_msgSend(_notificationsHistory, "count") > _maxHistory)
        objj_msgSend(_notificationsHistory, "removeObjectAtIndex:", 0);
}
},["void","CPString","CPString","id","id","SEL","id"]), new objj_method(sel_getUid("clearHistory"), function $TNGrowlCenter__clearHistory(self, _cmd)
{ with(self)
{
    objj_msgSend(_notificationsHistory, "removeAllObjects");
}
...
p;13;TNGrowlView.jt;9622;@STATIC;1.0;I;23;Foundation/Foundation.jI;16;AppKit/CPImage.jI;20;AppKit/CPImageView.jI;20;AppKit/CPTextField.jI;15;AppKit/CPView.jt;9484;objj_executeFile("Foundation/Foundation.j", NO);
...
new objj_method(sel_getUid("target"), function $TNGrowlView__target(self, _cmd)
{ with(self)
{
return _target;
}
